...
To test this properly, the experimental team — Mark Shein-Idelson, Janie Ondracek, Hua-Peng Liaw, Sam Reiter, and Gilles Laurent — needed long, continuous, high-quality recordings from the brains of awake and sleeping animals. The setup was as memorable as the result. The dragons were fitted with what we all called **"the hat"**: a small custom-built headstage cemented to the skull, from which thin cables emerged carrying signals from **silicon probes implanted deep in the brain** (in the dorsal ventricular ridge, the reptilian analogue of cortex). The animals lived their normal lives in their tanks while the system recorded **for weeks at a time**, capturing every nap, every overnight sleep cycle, every transition between states.
...
The volume of data those weeks-long recordings produced was substantial — multi-channel electrophysiology, sampled at high rate, sustained for days — and a meaningful chunk of my work was on the tooling around it: helping turn raw recording sessions into something a scientist could open at lunchtime and see at a glance whether the animal had slept normally the night before.
...
- **MATLAB analysis code.** Most of the lab's electrophysiology pipeline lived in MATLAB. I wrote and maintained tooling for **spike sorting workflows, oscillation detection, sleep-state classification, sharp-wave-ripple detection, spectral analysis, and quality-control plots** — the sort of code that takes a multi-gigabyte recording and turns it into a figure a scientist can stare at. A lot of the work was reading other people's analysis scripts (the genuine, beautiful chaos of working research code) and turning the parts that were stable into reusable modules that the rest of the team could share.
...
- **Data wrangling and infrastructure.** Helping organise raw recordings, calibration data, and metadata so that two years from now someone could still find which probe had been implanted in which animal, in which orientation, on which date.

None of this is what gets cited. But anyone who has worked in or near a wet-lab knows that the gap between a brilliant experimentalist and a published result is mostly software, and that the speed at which a lab can iterate on its own data is set by how good that software is.

## Personal Reflection

It was the only stretch of my career spent embedded in an academic neuroscience environment, and it shaped me more than the line on my CV suggests. Watching Mark, Janie, Sam, Mike Hemberger, Julien Fournier and the rest of the team **frame questions, design experiments, argue at lab meetings, and refuse to overinterpret a clean-looking plot** was a quiet education in scientific taste — the kind of taste that does not transfer to engineering directly but informs it permanently.

It also clarified something about my own preferences. I love being close to research. I also love shipping things that other people use. The role of *scientific software developer* — not a PI, not a postdoc, but the engineer who makes the science move faster — is a genuinely good role, and one that I think research institutes generally underinvest in. I left for industry in 2018, but I left with a high opinion of the people who stay.

The dragons, by the way, are still sleeping — and the turtle visual cortex is still doing whatever weird, non-retinotopic thing it does. The papers from that era keep being cited, and that feels like a small, vicarious privilege to have been adjacent to.
