...
description: "An EU FP7 project on indexing, searching and linking large archives of lectures, meetings and video-conferences as interconnected hyper-events. At Fraunhofer HHI I led the video-analysis side of the work — automatic segmentation, slide-transition detection and classification of long-form recordings — published at VISAPP 2014 and at the ACM MM 2013 Grand Challenge."
link_paper:  "https://www.scitepress.org/Papers/2014/46860/"
---

**inEvent** (*Accessing Dynamic Networked Multimedia Events*, FP7 grant agreement **287872**) was a three-year European research project running from **November 2011 to November 2014**, coordinated by the **Idiap Research Institute** in Switzerland. The consortium brought together six partners — three industrial and three research — including **Idiap**, **EPFL**, the **University of Edinburgh**, **IBM Research**, the Swiss webcasting company **Klewel**, and **Fraunhofer HHI**, where I worked during the entire run of the project.
